          ...
          <Grid mt={10}>
            <Grid display={"flex"} justifyContent={"center"}>
              <Grid
                ...
                onClick={
                  () =>
                    speak({
                      text: "You have sent rupees two thousand to Subhasis",
                    })
                  //   speak({
                  //     text: "You have sent rupees two thousand to Subhasis",
                  //   })
              ...
              >
                <Typography>{t("Subhasis - 2,000")}</Typography>
            ...
            <Grid display={"flex"} justifyContent={"center"} mt={3}>
              <Grid
                ...
                alignItems={"center"}
              >
                <Typography>{t("Dhruv - 50000")}</Typography>
            ...
            <Grid display={"flex"} justifyContent={"center"} mt={3}>
              <Grid
                ...
                // onClick={() => window.open("", "")}
              >
                <Typography>{t("Sarthak - 1300")}</Typography>
